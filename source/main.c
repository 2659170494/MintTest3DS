...
static const char *PATH = "romfs:/JoJo.opus";  // Path to Opus file to play
...
int main(int argc, char* argv[])
{
	...
	printf("GreenYoshi Build\n");
	printf("敢不敢比划一下什么叫黑手?\n");
	printf("Press A to play music\n");
